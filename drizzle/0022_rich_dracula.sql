...
INSERT INTO `__new_publishers`("id", "name", "display_name", "description", "homepage_url", "owner_user_id", "created_at") SELECT "id", "name", "display_name", "description", COALESCE("homepage_url", ''), "owner_user_id", "created_at" FROM `publishers`;--> statement-breakpoint
