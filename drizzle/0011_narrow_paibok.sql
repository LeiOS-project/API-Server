...
INSERT INTO `__new_package_releases`("id", "package_id", "versionWithLeiosPatch", "architectures", "created_at", "changelog") SELECT "id", "package_id", "versionWithLeiosPatch", "architectures", "created_at", "changelog" FROM `package_releases`;--> statement-breakpoint
