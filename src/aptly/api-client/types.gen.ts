...
export type GithubComAptlyDevAptlyDebRemoteRepo = {
    /**
     * List of architectures to fetch, if empty, then fetch all architectures
     */
    Architectures?: Array<string>;
...
export type GithubComAptlyDevAptlyTaskProcessReturnValue = {
    Code?: number;
    Value?: unknown;
};
...
export type GetApiMirrorsResponses = {
     ...
     * OK
     */
    200: Array<GithubComAptlyDevAptlyDebRemoteRepo>;
};
...
export type DeleteApiMirrorsByNameResponses = {
     ...
     * OK
     */
    200: GithubComAptlyDevAptlyTaskProcessReturnValue;
};
